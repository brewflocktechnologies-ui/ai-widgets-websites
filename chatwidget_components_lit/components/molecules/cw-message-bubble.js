...
let CwMessageBubble = class CwMessageBubble extends LitElement {
    constructor() {
        super(...arguments);
        this.chatWindowConfig = {};
...
], CwMessageBubble.prototype, "message", void 0);
__decorate([
    property({ type: Object })
], CwMessageBubble.prototype, "chatWindowConfig", void 0);
__decorate([
    property({ type: Boolean })
], CwMessageBubble.prototype, "isGroupEnd", void 0);
__decorate([
    property({ type: Boolean })
], CwMessageBubble.prototype, "isGroupStart", void 0);
__decorate([
    property({ type: String })
], CwMessageBubble.prototype, "agentName", void 0);
CwMessageBubble = __decorate([
    customElement('cw-message-bubble')
], CwMessageBubble);
export { CwMessageBubble };
//# sourceMappingURL=cw-message-bubble.js.map