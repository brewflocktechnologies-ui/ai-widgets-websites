...
let CwFormsPreview = class CwFormsPreview extends LitElement {
    constructor() {
        super(...arguments);
        this.type = 'prechat';
        this.heading = 'Submit a Support Ticket';
        this.subheading = 'We will get back to you within 24 hours.';
    }
    static { this.styles = [
        GLOBAL_STYLES,
        css `
    ...
    render() {
        ...
        <div class="phone-preview-card-container">
          ...
          <form class="phone-preview-body" @submit="${(e) => { e.preventDefault(); alert('Feedback submitted!'); }}">
      ...
      `;
        ...
        <div class="phone-preview-card-container">
          ...
          <form class="phone-preview-body" @submit="${(e) => { e.preventDefault(); alert('Ticket submitted!'); }}">
      ...
      <div class="phone-preview-card-container">
        ...
        <form class="phone-preview-body" @submit="${(e) => { e.preventDefault(); alert('Form submitted successfully!'); }}">
          <div class="phone-field-group">
...
], CwFormsPreview.prototype, "type", void 0);
__decorate([
    property({ type: String })
], CwFormsPreview.prototype, "heading", void 0);
__decorate([
    property({ type: String })
], CwFormsPreview.prototype, "subheading", void 0);
CwFormsPreview = __decorate([
    customElement('cw-forms-preview')
], CwFormsPreview);
export { CwFormsPreview };
//# sourceMappingURL=cw-forms-preview.js.map