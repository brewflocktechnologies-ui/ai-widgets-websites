...
let CwIcon = class CwIcon extends LitElement {
    constructor() {
        super(...arguments);
...
], CwIcon.prototype, "name", void 0);
__decorate([
    property({ type: Number })
], CwIcon.prototype, "size", void 0);
__decorate([
    property({ type: String })
], CwIcon.prototype, "color", void 0);
__decorate([
    property({ type: String })
], CwIcon.prototype, "customSvg", void 0);
CwIcon = __decorate([
    customElement('cw-icon')
], CwIcon);
export { CwIcon };
//# sourceMappingURL=cw-icon.js.map