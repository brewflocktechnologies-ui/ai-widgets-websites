...
import { subscribe } from '../../store/chat-store.js';
import { GLOBAL_STYLES } from '../../tokens/design-tokens.js';
import { getBorderRadius, getChatbarBackground, getChatbarFontSize, getChatbarIconWidth, getChatbarIconHeight } from '../../utils/style-helpers.js';
import '../atoms/cw-icon.js';
let CwChatbar = class CwChatbar extends LitElement {
    constructor() {
        super(...arguments);
    ...
    render() {
        const s = this.config || {};
        if (!s.enabled || (s.hideOnOpen && this.panelOpen))
            return html ``;
...
], CwChatbar.prototype, "config", void 0);
__decorate([
    property({ type: Boolean })
], CwChatbar.prototype, "panelOpen", void 0);
__decorate([
    property({ type: Number })
], CwChatbar.prototype, "unreadCount", void 0);
__decorate([
    state()
], CwChatbar.prototype, "hovered", void 0);
CwChatbar = __decorate([
    customElement('cw-chatbar')
], CwChatbar);
export { CwChatbar };
//# sourceMappingURL=cw-chatbar.js.map