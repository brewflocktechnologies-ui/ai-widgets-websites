...
import { chatStore, chatWindowStore, featuresStore, subscribeAll } from '../../store/chat-store.js';
import { GLOBAL_STYLES } from '../../tokens/design-tokens.js';
import '../atoms/cw-avatar.js';
let CwChatHeader = class CwChatHeader extends LitElement {
    constructor() {
        super(...arguments);
        this.isExpanded = false;
        this.clientName = 'Support';
...
], CwChatHeader.prototype, "config", void 0);
__decorate([
    property({ type: Object })
], CwChatHeader.prototype, "features", void 0);
__decorate([
    property({ type: Boolean })
], CwChatHeader.prototype, "isExpanded", void 0);
__decorate([
    property({ type: String })
], CwChatHeader.prototype, "clientName", void 0);
__decorate([
    property({ type: String })
], CwChatHeader.prototype, "agentName", void 0);
__decorate([
    property({ type: String })
], CwChatHeader.prototype, "state", void 0);
CwChatHeader = __decorate([
    customElement('cw-chat-header')
], CwChatHeader);
export { CwChatHeader };
//# sourceMappingURL=cw-chat-header.js.map