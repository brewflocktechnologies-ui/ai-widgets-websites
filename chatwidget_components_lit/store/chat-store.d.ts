...
export declare function subscribe(event: string, callback: () => void): () => void;
export declare function subscribeAll(callback: () => void): () => void;
export declare const bubbleStore: {
    get(): BubbleState;
};
export declare const greetWindowStore: {
    get(): GreetWindowState;
};
export declare const chatWindowStore: {
    get(): ChatWindowState;
};
export declare const featuresStore: {
    get(): FeaturesState;
};
export declare const chatbarStore: {
    get(): ChatbarState;
};
